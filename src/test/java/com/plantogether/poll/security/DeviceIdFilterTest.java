...
/**
 * Security regression test — verifies DeviceIdFilter is active in poll-service (R01).
 *
 * DeviceIdFilter is auto-configured by plantogether-common SecurityAutoConfiguration.
 * These tests ensure the filter remains wired and functional across service updates.
 */
